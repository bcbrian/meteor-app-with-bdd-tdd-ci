...
import { incWatingOn, decWatingOn } from '/imports/api/loadingCounter/methods.js';
        ...
        return(
            ...
            <hr/>
              <div className="card-columns">
                <div className="card" onClick={this.showLoading.bind(this)}>
                  ...
                  <div className="card-block">
                    <h4 className="card-title">Click on me to see loading screen</h4>
                    <p className="card-text">Loading screen will show fow a few seconds. It uses a collection to determine if it should be visible or not.</p>
                  </div>
                </div>
